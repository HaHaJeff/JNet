...
static void InitDefaultsscc_info_RpcMessage_rpc_2eproto() {
  ...
  {
    void* ptr = &::_RpcMessage_default_instance_;
    new (ptr) ::RpcMessage();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::RpcMessage::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_rpc_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::RpcMessage, service_),
  PROTOBUF_FIELD_OFFSET(::RpcMessage, method_),
  PROTOBUF_FIELD_OFFSET(::RpcMessage, request_),
  PROTOBUF_FIELD_OFFSET(::RpcMessage, response_),
  5,
  4,
  0,
  1,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_rpc_2eproto = {
  &descriptor_table_rpc_2eproto_initialized, descriptor_table_protodef_rpc_2eproto, "rpc.proto", 175,
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(_internal_mutable_service(), ptr, ctx, "RpcMessage.service");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 34)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(_internal_mutable_method(), ptr, ctx, "RpcMessage.method");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:RpcMessage)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:RpcMessage)
  GOOGLE_DCHECK_NE(&from, this);
  const RpcMessage* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<RpcMessage>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:RpcMessage)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:RpcMessage)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:RpcMessage)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::RpcMessage* Arena::CreateMaybeMessage< ::RpcMessage >(Arena* arena) {
  return Arena::CreateInternal< ::RpcMessage >(arena);
}
