...
void RpcMessage::set_service(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:RpcMessage.service)
}
#endif
...
void RpcMessage::set_method(::std::string&& value) {
  ...
  method_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:RpcMessage.method)
}
#endif
...
void RpcMessage::set_request(::std::string&& value) {
  ...
  request_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:RpcMessage.request)
}
#endif
...
void RpcMessage::set_response(::std::string&& value) {
  ...
  response_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:RpcMessage.response)
}
#endif
